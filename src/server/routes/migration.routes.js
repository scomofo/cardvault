          ...
          run(
            `INSERT OR IGNORE INTO user_items
             (id, parallel_id, intake_batch_id, purchase_id, name, player_name,
              ...
              front_img_id, back_img_id, price_estimate, price_history, market_price,
              ...
              cv_centering_tb, cv_centering_score, cv_processed, created_at, updated_at)
             VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)`,
            [
              item.id,
              ...
              firstDefined(item.cv_centering_lr),
              firstDefined(item.cv_centering_tb),
              firstDefined(item.cv_centering_score),
              firstDefined(item.cv_processed, 0),
