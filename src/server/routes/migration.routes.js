import { run, runInImmediateTransaction } from "../database.js";
...
import { normalizeSettingKey, WRITABLE_SETTINGS_KEYS } from "../services/settingsKeys.js";
...
export function registerMigrationRoutes(app) {
  app.post("/api/migrate", requireProtectedConfigWrite, validateMigrationPayload, (req, res) => {
    try {
      const data = req.body;
